...
The first public tag should be `v0.1.0`, not `v1.0.0`. The SDK is still
missing some planned workflows and has not yet had broad external developer
testing, so keeping the release pre-v1 correctly signals that public APIs may
still change.
